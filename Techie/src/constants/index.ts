...
export const TOOL_DEFINITIONS: ToolDefinition[] = [
  ...
  { id: 'math-viva', title: 'Laboratorio de Mate 🧪', desc: '¡Juega con bloques gigantes y descubre cómo funcionan los números!', iconPath: 'M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z', iconBg: 'bg-blue-950', iconText: 'text-blue-100' },
  ...
  { id: 'quiz-master', title: 'Desafío de Saber 🏆', desc: '¡Ponte a prueba y gana medallas respondiendo preguntas!', iconPath: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2', iconBg: 'bg-pink-600', iconText: 'text-white' },
  ...
  { id: 'inventor', title: 'Lab de Inventos 🛠️', desc: '¡Crea inventos increíbles con cosas que tengas en casa!', iconPath: 'M11 4a2 2 0 114 0v1a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-1a2 2 0 100 4h1a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-1a2 2 0 10-4 0v1a1 1 0 01-1 1H7a1 1 0 01-1-1v-3a1 1 0 00-1-1H4a2 2 0 110-4h1a1 1 0 001-1V7a1 1 0 011-1h3a1 1 0 001-1V4z', iconBg: 'bg-emerald-600', iconText: 'text-white' },
  { id: 'language-buddy', title: 'Amigo de Idiomas 🗣️', desc: '¡Practica inglés u otros idiomas de forma natural y divertida!', iconPath: 'M3 5h12V3H3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2v-7h-2v7H3V5zm11 7l-2.5-2.5-1.42 1.42L12.17 13l-3.08 3.08 1.42 1.42L14 14.17 17.5 17.67l1.42-1.42L14 11.33z', iconBg: 'bg-teal-600', iconText: 'text-white' },
  { id: 'alchemist', title: 'Alquimista de Ideas ⚗️', desc: '¡Combina elementos y descubre nuevas creaciones mágicas!', iconPath: 'M19.484 15.097l-6.59-10.456a2.001 2.001 0 00-3.388 0l-6.59 10.456A2.001 2.001 0 004.584 18h14.832a2.001 2.001 0 001.068-2.903zM12 7.5l4.5 7.5H7.5L12 7.5z', iconBg: 'bg-indigo-600', iconText: 'text-white' },
